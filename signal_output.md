## A-Share Index Futures Signal — 2026-08-28
...
|-------|------|-------|--------|-----|
| SPX | 2026-08-27 | 7730.99 | +0.72% | 1d |
| NDX | 2026-08-27 | 26541.35 | +1.57% | 1d |

### Signals triggered: **1 / 4**

| Futures | Underlying | Action | Qty | Signal | Trigger |
|---------|------------|--------|-----|--------|---------|
| **IM** | 中证1000 | `SHORT_AT_OPEN` | 1 手 | NDX=+1.57% | ≥ 1.0% |
...
|------|----------|---------|--------|--------|-----|------|-------|
| 1 | IH_fade_short | IH | NDX | +1.57% | 2.0% | ❌ | 最稳; 10年里8年正收益; 大盘金融蓝筹反应最强 |
| 2 | IF_fade_short | IF | NDX | +1.57% | 2.0% | ❌ | 次稳; 与 IH 同信号但反应弱; |
| 3 | IC_fade_short | IC | SPX | +0.72% | 1.5% | ❌ | 用 SPX 阈值低; 2021-2023 连亏需警惕 |
| 4 | IM_fade_short | IM | NDX | +1.57% | 1.0% | ✅ | 样本仅5年; 2024年贡献全部收益; 高波动 |